...
source(file.path(engine_root, "functions.R"))
...
# met_int <- interpolate(
#   met,
#   "Data/for_buildr/basin.shp",
#   "Data/for_buildr/DTM5m.tif",
#   5000
# )
# 
# met_int_path <- file.path(
#   dirname(weather_path),
#   "met_int.rds"
# )
# 
# saveRDS(met_int, met_int_path)
...
frm$schedule_operations(start_year = 2000, end_year = 2024,
                        replace = 'all')
# save.image(file = "my_environment.RData")
frm$write_operations(start_year = 2000, end_year = 2024)
